...
set defines=
set opts=-m32 -O3 -Xcompiler -openmp --expt-extended-lambda -lineinfo -keep --keep-dir m:\cuda-temp
...
"C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v8.0\bin\nvcc" %defines% %opts% %includes% radix_sort.cu cuda.lib -o radix-sort-cuda.exe %*
del *.exp *.lib 2>nul
